insert into Project values
 ('Take care of bears in the Hungary forests', '20210725', '20211103', 
 'The volunteers will have to participate in workshops on the threats for wildlife and street animals in Hungary and take the input of that for making the people aware of the issue and bringing forward solutions. They will have to engage with different local stakeholders in order to mitigate the issue by engaging in various animal welfare activities.',
 'Visiting the forests and animal hospitals of Hungary 
Raising awareness on Hungary''s biodiversity, street animal issues on social media platforms. 
Participating in project events such as surveys, educational sessions, and other animal welfare camp
Creating documentaries on the impact created through the project.',
17)

insert into Project values
 ('Help turtles to reach the water in Portugal', '20210515', '20210809', 
...
Digging holes
Moving sand
Charting nesting patterns
Recording births
Recording release programs',
23)
...
insert into City values
 ...
 ('Chisinau', 140),
 ('Auckland', 153),
 ('Ciudad de Mexico', 138)

 insert into [Location] values
('Calea Grivitei', 158, 1),
('Calea Sperantei', 13, 2),
('Zelinski', 10, 3),
('Great Street', 7, 4),
...
insert into LevelOfEducation values
('Associate Degree'),
('Bachelor'),
('Doctorate'),
('High School'),
